...
left join snowflake_dbt_source.public.jaffle_shop_customers c on orders.user_id = c.id ),
...
customer_orders 
    ...
    from snowflake_dbt_source.public.jaffle_shop_customers c 
    left join snowflake_dbt_source.public.jaffle_shop_orders as orders
